...
public class perguntaManter extends javax.swing.JFrame {
    ...
    private void botaoInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoInserirActionPerformed
        ...
        if (txtId.getText().isEmpty() || txtEnunciado.getText().isEmpty() || txtA.getText().isEmpty() || txtB.getText().isEmpty() || txtC.getText().isEmpty() || txtD.getText().isEmpty() || txtCerta.getText().isEmpty() || txtNivel.getText().isEmpty()) 
            {
    ...
    private void botaoConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoConsultarActionPerformed
        ...
        for (Pergunta lista1 : lista)
        {
            if (pergunta.equalsIgnoreCase(lista1.getEnunciado()))
            {
                ...
                txtCerta.setText(lista1.getCerta());
                txtNivel.setText(lista1.getNivel().toString());
    ...
    private void botaoPrimeiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoPrimeiroActionPerformed
        ...
        if (lista.size()>0)
        {
            ...
            txtCerta.setText(elemento.getCerta());
